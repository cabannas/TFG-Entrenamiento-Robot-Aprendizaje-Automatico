...
public class AgentControl : Agent
{
    ...
    public GameObject EFloor1, EFloor2, EFloor3, EFloor4, EFloor5,
                      EFloor6, EFloor7, EFloor8, EFloor9, EFloor10,
                      EFloor11, EFloor12, EFloor13, EFloor14, EFloor15,
                      EFloor16;
    ...
    public override void OnEpisodeBegin(){
      ...
      EFloor1.GetComponent<Renderer>().material.color = Color.red;
      EFloor2.GetComponent<Renderer>().material.color = Color.red;
      EFloor3.GetComponent<Renderer>().material.color = Color.red;
      EFloor4.GetComponent<Renderer>().material.color = Color.red;
      EFloor5.GetComponent<Renderer>().material.color = Color.red;
      EFloor6.GetComponent<Renderer>().material.color = Color.red;
      EFloor7.GetComponent<Renderer>().material.color = Color.red;
      EFloor8.GetComponent<Renderer>().material.color = Color.red;
      EFloor9.GetComponent<Renderer>().material.color = Color.red;
      EFloor10.GetComponent<Renderer>().material.color = Color.red;
      EFloor11.GetComponent<Renderer>().material.color = Color.red;
      EFloor12.GetComponent<Renderer>().material.color = Color.red;
      EFloor13.GetComponent<Renderer>().material.color = Color.red;
      EFloor14.GetComponent<Renderer>().material.color = Color.red;
      EFloor15.GetComponent<Renderer>().material.color = Color.red;
      EFloor16.GetComponent<Renderer>().material.color = Color.red;
